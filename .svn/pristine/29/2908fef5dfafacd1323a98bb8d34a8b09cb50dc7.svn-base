...
Created: 2012-11-09
Modified: 2012-12-18
Project: Salon motocyklowy
Model: Salon motocyklowy
Company: PW EiTI
Author: Piotr Ma³ecki, Mateusz Filipowicz
Version: 1.0.2
...
ALTER TABLE Egzemplarze ADD CONSTRAINT naPaliwo FOREIGN KEY (paliwo) REFERENCES RodzajePaliwa (paliwo)
/
